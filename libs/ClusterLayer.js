  ...
  return declare([GraphicsLayer], {
    ...
    add: function(p) {
      ...
      if ( ! clustered ) {
        ...
        if(p.attributes._result === 'W'){
        	p.attributes.winCount = 1;
        }
        else{
        	p.attributes.winCount = -1;
        }
    ...
    _clusterAddPoint: function(p, cluster) {
      ...
      // increment the count
      cluster.attributes.winCount += winCount;
    ...
    _showCluster: function(c) {
      ...
      var label = new TextSymbol(Math.abs(c.attributes.winCount).toString())
    ...
    _updateLabel: function(c) {
      ...
      if ( label.length == 1 ) {
        ...
        this.remove(label[0]);
        var newLabel = new TextSymbol(Math.abs(c.attributes.winCount))
          .setColor(new Color(this._clusterLabelColor))
          .setOffset(0, this._clusterLabelOffset);
        this.add(
          new Graphic(
